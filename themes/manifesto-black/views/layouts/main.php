    ...
    <body>
                ...
                <div class="head_top">
                    <div class="topbuts">
                        ...
                        <div class="user clear">
                            <img src="<?php echo Yii::app()->theme->baseUrl; ?>/images/avatar.jpg" class="avatar" alt="" />
        ...
        <div class="footer">
            <div class="pagesize clear">
                ...
                <img src="<?php echo Yii::app()->theme->baseUrl; ?>/images/logo_earth.png" width="80" alt="" class="block center" style="opacity:.3;" />
            </div>
        </div>
