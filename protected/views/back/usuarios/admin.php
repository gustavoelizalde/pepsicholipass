        ...
        <div class="box-wrap clear">
            ...
            <div class="clear" style="margin-bottom:20px;">
                ...
                <div class="clear">
                    ...
                    <?php if (Yii::app()->user->checkAccess('crearUsuarios') || Yii::app()->user->id == 'admin-root') { ?>
                        <?php echo CHtml::link('Crear Nuevo', array('usuarios/create'), array('class' => 'button blue fl')); ?>
                    <?php } ?>
                </div>
            ...
            <?php
            if ((Yii::app()->user->checkAccess('editarUsuarios') && Yii::app()->user->checkAccess('eliminarUsuarios')) || Yii::app()->user->id == 'admin-root')
                $template = '{update}{delete}';
            elseif (Yii::app()->user->checkAccess('editarUsuarios'))
                $template = '{update}';
            elseif (Yii::app()->user->checkAccess('eliminarUsuarios'))
                $template = '{delete}';
            else
                $template = '';
