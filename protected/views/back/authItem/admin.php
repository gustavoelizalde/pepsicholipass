        ...
        <div class="box-wrap clear">
            ...
            <div class="clear" style="margin-bottom:20px;">
                ...
                <div class="clear">
                    ...
                    <?php if (Yii::app()->user->checkAccess('crearRoles') || Yii::app()->user->id == 'admin-root') { ?>
                        <?php echo CHtml::link('Crear Nuevo', array('authItem/create'), array('class' => 'button blue fl')); ?>
                    <?php } ?>
                </div>
            ...
            <?php
            if ((Yii::app()->user->checkAccess('editarRoles') && Yii::app()->user->checkAccess('eliminarRoles')) || Yii::app()->user->id == 'admin-root')
                $template = '{update}{delete}';
            elseif (Yii::app()->user->checkAccess('editarRoles'))
                $template = '{update}';
            elseif (Yii::app()->user->checkAccess('eliminarRoles'))
                $template = '{delete}';
            else
                $template = '';
