<body>
    ...
    <script>
        ...
        $('#userdate').submit(function() {
            ...
            if (validarEmail('input[name="Registrados[email]"]') == true && $('input[name=terms]').is(':checked') == true && $('textarea[name="Registrados[comentario]"]').val().length != 0 && $('textarea[name="Registrados[comentario]"]').val() != '¿Qué significa para ti Vivir Hoy?' && $('input[name="Registrados[telefono]"]').val() != 'Teléfono' && $('input[name="Registrados[telefono]"]').val().length != 0) {
                //aca grabar en la bd
                        ...
                        FB.ui(
                                {
                                    ...
                                    link: 'https://www.facebook.com/pepsipr/app_623431217672700',
...
//                            }
                ...
                if ($('input[name="Registrados[telefono]"]').val() == 'Teléfono' || $('input[name="Registrados[telefono]"]').val().length == 0) {
                    alert('Necesitas completar el campo: Teléfono');
                }
