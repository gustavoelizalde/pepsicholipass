...
class StaffController extends Controller {
    ...
    public function accessRules() {
        return array(
            ...
            array('allow',
                'actions' => array('index'),
                'expression' => 'Yii::app()->user->checkAccess("listarStaff")',
            ),
            array('allow',
                'actions' => array('create'),
                'expression' => 'Yii::app()->user->checkAccess("crearStaff")',
            ),
            array('allow',
                'actions' => array('update'),
                'expression' => 'Yii::app()->user->checkAccess("editarStaff")',
            ),
            array('allow',
                'actions' => array('delete'),
                'expression' => 'Yii::app()->user->checkAccess("eliminarStaff")',
            ),
            array('deny',
                'users' => array('*'),
            ),
        ...
        if (isset($_POST['Staff'])) {
            ...
            if ($model->save()) {
                ...
                for ($i = 0; $i < count($_POST['roles']); $i++)
                    Yii::app()->authManager->assign($_POST['roles'][$i], $model->id);
